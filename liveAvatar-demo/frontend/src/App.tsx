...
function App() {
  ...
  const startSession = async () => {
    try {
      ...
      let currentContextId = import.meta.env.VITE_CONTEXT_ID || 'ab9f75be-5932-4878-a577-d80d9deb038f';
      ...
      const response = await fetch(`${API_URL}/api/session`, {
        ...
        body: JSON.stringify({
          ...
          llm_configuration_id: import.meta.env.VITE_LLM_CONFIG_ID || '72090d75-09c7-4c6a-a3c5-809862722f7d',
